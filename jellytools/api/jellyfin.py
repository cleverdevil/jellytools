...
class JellyfinClient:
    ...
    def _post(self, path: str, params: Optional[Dict] = None, 
             data: Optional[Dict] = None, headers: Optional[Dict] = None, 
             binary_data: Optional[bytes] = None) -> Dict:
    ...
    def items_list(self, parentId: Optional[str] = None, limit: Optional[int] = None, 
                  recursive: bool = False, include_fields: bool = False) -> Dict:
        """
    ...
    def download_image(self, item_id: str, image_type: str = 'Primary') -> Dict[str, Any]:
        """
        ...
        extension = {
            ...
            'image/jpeg': 'jpg', 
            'image/webp': 'webp'
        }.get(response.headers['content-type'], 'jpg')
    ...
    def upload_image(self, item_id: str, image_type: str, image_data: bytes, image_ext: str = 'jpg') -> bool:
        """
