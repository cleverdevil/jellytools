...
class AnimationManager:
    ...
    def create_animation(self, animation_type: str, library_name: str, 
                        posters: List[pygame.Surface]) -> BaseAnimation:
        """
        ...
        if animation_type not in self.animation_types:
            logger.warning(f"Animation type '{animation_type}' not found. Using 'grid' as fallback.")
            animation_type = 'grid'
